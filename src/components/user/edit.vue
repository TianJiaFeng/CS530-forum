<template>
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 >Edit<button class="btn btn-default pull-right" v-link="{path: '/user'}">Return</button></h4>
    </div>
    ...
    <div class="panel-footer">
      <button class="btn btn-default" v-link="{path: '/user'}">Cancel</button>
